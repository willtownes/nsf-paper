...
loadings from NPFH
```{r}
W<-read.csv(fp(pth,"results/xyz_liv_npfh6_spde_loadings.csv"),header=TRUE,row.names=1)
...
res$dim<-rep(1:3,2)
write.csv(res[,c(1,4,2,3)],fp(pth,"results/xyz_liv_npfh6_spde_goterms.csv"),row.names=FALSE)
```
...
```{r}
res<-read.csv(fp(pth,"results/xyz_liv_npfh6_spde_goterms.csv"),header=TRUE)
...
write.csv(res,fp(pth,"results/xyz_liv_npfh6_spde_goterms.csv"),row.names=FALSE)
```
Shorter GO table
```{r}
res<-read.csv(fp(pth,"results/xyz_liv_npfh6_spde_goterms.csv"),header=TRUE)
...
write.csv(res2,fp(pth,"results/xyz_liv_npfh6_spde_goterms_short.csv"),row.names=FALSE)
```
